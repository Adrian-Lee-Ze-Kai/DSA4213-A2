...
vocab, stoi, itos = train_ds.vocab, train_ds.stoi, train_ds.itos
val_ds = WordLMSeqDataset("monkeypox_ds/val.txt", block_size, vocab, stoi, itos)
test_ds = WordLMSeqDataset("monkeypox_ds/test.txt", block_size, vocab, stoi, itos)
...
plt.legend()
plt.tight_layout()
plot_path = os.path.join(runs_dir, "loss_curves_epoch.png")
